...
export const AppOverviewSection = () => {
  return (
    <section className="relative flex flex-col sm:flex-row w-full sm:h-40 items-center gap-4 sm:gap-8 px-4 sm:px-7 py-6 sm:py-8 rounded-2xl overflow-visible bg-[linear-gradient(0deg,rgba(246,247,248,1)_0%,rgba(246,247,248,1)_100%),linear-gradient(0deg,rgba(239,242,245,1)_0%,rgba(239,242,245,1)_100%)]">
      ...
      <img
        className="w-full sm:w-[198px] h-auto object-contain"
