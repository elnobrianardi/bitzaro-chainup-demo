...
import bitEarn from "../assets/Add-On/bit-earn.png";
    ...
    <section className="relative w-full h-auto sm:h-[352px] flex flex-col items-start rounded-2xl overflow-hidden bg-[linear-gradient(0deg,rgba(14,119,255,0.08)_0%,rgba(14,119,255,0.08)_100%),linear-gradient(0deg,rgba(255,255,255,1)_0%,rgba(255,255,255,1)_100%)]">
      ...
      <div className="flex flex-col items-start gap-2.5 p-6 sm:p-8 w-full z-10">
        <h2 className="text-xl xs:text-2xl sm:text-3xl leading-8 sm:leading-10 font-medium text-[#323232] tracking-[0]">
          ...
          <span className="font-bold text-[#1761f5] text-[42px] sm:text-[40px] leading-[35px] sm:leading-[52.5px]">
            &nbsp;25%
          </span>
      ...
      {/* Image below text */}
      <div className="w-full flex justify-center mt-auto h-[200px] sm:h-[220px]">
        <img
