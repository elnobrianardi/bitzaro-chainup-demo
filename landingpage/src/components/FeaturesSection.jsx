...
export const FeaturesSection = () => {
  return (
    <section className="flex w-[574px] h-40 items-center gap-8 px-7 py-8 rounded-2xl overflow-hidden bg-[linear-gradient(0deg,rgba(246,247,248,1)_0%,rgba(246,247,248,1)_100%),linear-gradient(0deg,rgba(239,242,245,1)_0%,rgba(239,242,245,1)_100%)]">
      <img
        className="relative w-[198px] h-40 mt-[-32.00px] mb-[-32.00px]"
      ...
      <button
        className="inline-flex items-center gap-2.5 p-2 bg-white rounded-[50px] overflow-hidden hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
